...
public class SecureLoginController {
    ...
    public SecureLoginController(SendEmailService sendEmailService, UserConfig userConfig) {
    ...
    public String handleRecoverPassword(@RequestParam("email") String email) {
        ...
        String body = "Seu usuername é: " + userConfig.getUserUsername() + " e sua senha é: " + userConfig.getUserPassword();
